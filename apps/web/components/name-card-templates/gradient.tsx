...
export const gradientPageClass =
  "bg-gradient-to-br from-purple-950 via-purple-900 to-violet-800";
...
export function GradientTemplate({ identity }: { identity: NameCardIdentity }) {
  return (
    <div className={`min-h-svh ${gradientPageClass} flex items-center justify-center px-6`}>
      <GradientCard identity={identity} />
    </div>
  );
}
