...
export const minimalPageClass = "bg-neutral-50 dark:bg-neutral-950";

export function MinimalCard({ identity }: { identity: NameCardIdentity }) {
  return (
...
export function MinimalTemplate({ identity }: { identity: NameCardIdentity }) {
  return (
    <div className={`min-h-svh ${minimalPageClass} flex items-center justify-center px-6`}>
      <MinimalCard identity={identity} />
    </div>
  );
}
